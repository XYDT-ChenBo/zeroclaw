...
impl Tool for WeatherTool {
    ...
    fn description(&self) -> &str {
        "Query weather-related endpoints by stationid using configured [weather] endpoints. \
         Each query_type maps to a configured URL; stationid overrides the stationid. \
         Returns the upstream API response body as a string."
    }
    ...
    fn parameters_schema(&self) -> serde_json::Value {
        ...
        serde_json::json!({
            ...
            "properties": {
                ...
                "stationid": {
                    "type": "string",
                    "description": "Station id (single stationid or up to 20 stationids joined by '|'); falls back to stationid when omitted"
                }
            },
            "required": ["query_type"]
        })
